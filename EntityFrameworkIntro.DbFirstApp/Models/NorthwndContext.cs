...
namespace EntityFrameworkIntro.DbFirstApp.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=AKINCENGIZ;Initial Catalog=NORTHWND;Integrated Security=True;Trust Server Certificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Operatio__3214EC0722A5488A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07B585EB63");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserOper__3214EC076FA19A60");
        });
